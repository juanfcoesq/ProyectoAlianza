...
public class AltaMaterial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.add(jPanel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 400, 220, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AltaMaterial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AltaMaterial().setVisible(true);
            }
        });
    }
